...
func calculate_timings():
	...
	# determine early out time
	early_out_time = windup_length + active_length + recovery_length
	charge_time = 0.0
	
	# determine active frames
	hit_detect_start_time = windup_length + charge_time
	hit_detect_end_time = hit_detect_start_time + active_length
